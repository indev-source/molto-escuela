...
@section('breadcrumb')
    <div class="row">
        <div class="col-7 align-self-center">
            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Listado de planteles</h3>
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                <a href="/planteles/create" class="btn btn-primary"><span class="fas fa-home"></span> Registrar nuevo</a>
            </div>
        </div>
    </div>
@stop
