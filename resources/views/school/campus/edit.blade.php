    ...
    <div class="row">
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                <a href="/empleados" class="btn btn-primary"><span class="fas fa-list"></span> Listado de planteles</a>
            </div>
        </div>
    </div>
@stop
@section('content')
    <form action="{{asset('planteles/'.$campus->id)}}" method="post">
        @csrf
        {{method_field('put')}}
            ...
            <div class="col-md-6">
                <div class="card text-white bg-dark">
                    ...
                    <div class="card-body">
                        ...
                        @include('school.address.form-edit',['address'=>$campus->address])
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card text-white bg-dark">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::select('representative_id',$representatives,$campus->representative_id,['class'=>'form-control','placeholder'=>'Selecciona un representante del plantel']) !!}
                    </div>
